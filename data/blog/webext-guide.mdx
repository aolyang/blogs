...
```typescript:vite.config.ts {3,4,9}
...
3. Chrome官方示例demos列表 https://developer.chrome.com/docs/extensions/samples/#search:chrome_url_overrides;
4. create-chrome-ext`npm create chrome-ext`github源代码仓库 https://github.com/guocaoyi/create-chrome-ext；
5. @crxjs/vite-plugin插件文档 https://crxjs.dev/vite-plugin;
6. @crxjs/vite-plugin插件源代码仓库 https://github.com/crxjs/chrome-extension-tools;
